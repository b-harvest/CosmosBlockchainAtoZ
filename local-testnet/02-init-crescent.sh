...
VALIDATOR_2=$(echo "$MNEMONIC_VALIDATOR_2" | $BINARY keys add validator --recover --keyring-backend test --output json --home $VHOME 2>&1| jq -r '.address')
...
RELAYER_WALLET=cre1c855drgu0q6527twn2v74lt2a2u473ew0zdg2g
VALIDATOR_1_WALLET=cre1pjelxr9745772tfpma4jzllvrw4xqx9j704j6l
